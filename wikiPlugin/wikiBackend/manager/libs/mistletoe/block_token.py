...
from . import block_tokenizer as tokenizer
from . import span_token
...
class Paragraph(BlockToken):
    ...
    def read(cls, lines, span = None):
        ...
        lineManager.linesToRet = lineManager.lines()
        return line_buffer
...
class ListItem(BlockToken):
    ...
    @classmethod
    def read(cls, lines, prev_marker=None, span=None):
        next_marker = None
        lines.anchor()
        prepend = -1
        leader = None
